classdef Ensemble1 < classreg.learning.ensemble.CompactEnsemble
%Ensemble Ensemble.
...
%   Copyright 2010-2013 The MathWorks, Inc.
    ...
    methods(Static,Hidden)
        function catchUOFL(varargin)
            ...
            if ~isempty(usenfort)
                error(message('stats:classreg:learning:ensemble1:Ensemble1:catchUOFL:NonEmptyUseObsForLearner'));
            end
        end
    ...
    methods(Hidden)
        function this = removeLearners(this,~)
            error(message('stats:classreg:learning:ensemble1:Ensemble1:removeLearners:Noop'));
        end
    end
       
    methods(Access=protected)
        function this = Ensemble1()
