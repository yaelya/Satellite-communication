...
%   Copyright 2010 The MathWorks, Inc.
    ...
    methods(Access=protected)
        ...
        function this = DisallowVectorOps1()
        end
    end
    ...
    methods(Hidden)
        function [varargout] = subsref(this,s)
            ...
            if     strcmp(s(1).type,'()')
                error(message('stats:classreg:learning:internal:DisallowVectorOps1:subsref:SubscriptReferenceNotAllowed',className));
            elseif strcmp(s(1).type,'{}')
                error(message('stats:classreg:learning:internal:DisallowVectorOps1:subsref:CellReferenceNotAllowed',className));
            else
        ...
        function [varargout] = subsasgn(this,s,data)
            className = class(this);
            if     strcmp(s(1).type,'()')
                error(message('stats:classreg:learning:internal:DisallowVectorOps1:subsasgn:SubscriptAssignmentNotAllowed',className));
            elseif strcmp(s(1).type,'{}')
                error(message('stats:classreg:learning:internal:DisallowVectorOps1:subsasgn:CellAssignmentNotAllowed',className));
            else
        ...
        function throwUndefinedError(this,s)
            error(message('stats:classreg:learning:internal:DisallowVectorOps1:UndefinedMethod', s, class( this )));
        end
        
        function throwNoCatError(this)
            error(message('stats:classreg:learning:internal:DisallowVectorOps1:ConcatenationNotAllowed',class(this)));
        end
    end
