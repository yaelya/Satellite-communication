%https://www.mathworks.com/matlabcentral/fileexchange/33170-multi-class-support-vector-machine/

function [itrfin] = multisvm( T,C,test )
%
(3.0) classifies the class of given training vector according to the 
